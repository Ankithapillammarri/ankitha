...
public class AdminServiceTest {
	...
	private AdminService service;
		...
		public void testAddBookValid() {
			...
			bean.setBookName("English");
			bean.setAuthor("Sharma");
			bean.setCategory("Language");
			bean.setPublisher("Rk");
		...
		public void testRemoveBookValid() {
			boolean check = service.removeBook(102);
			Assertions.assertTrue(check);
		}
		...
		public void testIssueBookValid() {
			boolean check = service.issueBook(102, 100202);
			Assertions.assertTrue(check);
		}
		
		@Test
		public void testIssueBookInvalid() {
			boolean check = service.issueBook(109, 100203);
			Assertions.assertFalse(check);
		}
		
		@Test
		public void testBookHistoryDetailsValid() {
			List<Integer> info = service.bookHistoryDetails(100202);
		...
		public void testBookHistoryDetailsInvalid() {
			List<Integer> info = service.bookHistoryDetails(100203);
			Assertions.assertNotNull(info);
